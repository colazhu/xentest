...
typedef struct libxl_device_vgsx {
    libxl_domid backend_domid;
    char * backend_domname;
    libxl_devid devid;
    uint32_t osid;
} libxl_device_vgsx;
void libxl_device_vgsx_dispose(libxl_device_vgsx *p);
void libxl_device_vgsx_copy(libxl_ctx *ctx, libxl_device_vgsx *dst, const libxl_device_vgsx *src);
void libxl_device_vgsx_init(libxl_device_vgsx *p);
char *libxl_device_vgsx_to_json(libxl_ctx *ctx, libxl_device_vgsx *p);
int libxl_device_vgsx_from_json(libxl_ctx *ctx, libxl_device_vgsx *p, const char *s);
